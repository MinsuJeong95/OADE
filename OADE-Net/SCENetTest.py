...
def test(datasetType, Fold, modelTypes, modelType, models, sceNet, DBPath, geometric):
    batchSize = 100
    ...
    for modelPath in modelPaths:
        ...
        with torch.no_grad():
            ...
            for probI in range(allCamProbClassLen):
                if geometric == True:
                    # geometric
                    probCenterImg, probCenterName = distenseCal(allCamProbiter, model1, device)
